...
export default function Supplements() {
  ...
  // All other functions (saveNutritionData, addProtein, etc.) are unchanged
  ...
  return (
    // Replaced custom classes with theme-aware Tailwind classes
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="w-full bg-card-elevated rounded-full h-3 mb-4">
              <div 
                className="bg-primary-accent h-3 rounded-full transition-all duration-300" 
            ...
            <div className="space-y-2">
              <div className="flex gap-2">
                <Button variant="outline" size="sm" onClick={() => { /* function unchanged */ }} className="flex-1 bg-card-elevated border-border text-text-secondary hover:bg-border"> +25g </Button>
                <Button variant="outline" size="sm" onClick={() => { /* function unchanged */ }} className="flex-1 bg-card-elevated border-border text-text-secondary hover:bg-border"> +50g </Button>
              </div>
              <div className="flex gap-2">
                ...
                <Button variant="outline" size="sm" onClick={() => { /* function unchanged */ }} className="bg-card-elevated border-border text-text-secondary hover:bg-border"> Add </Button>
              </div>
              {lastProteinAction > 0 && (
                <Button variant="outline" size="sm" onClick={() => { /* function unchanged */ }} className="w-full bg-card-elevated border-border text-text-secondary hover:bg-red-500/10 hover:text-red-500"> Undo (-{lastProteinAction}g) </Button>
              )}
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg p-6 border border-border">
            ...
            <div className="w-full bg-card-elevated rounded-full h-3 mb-4">
             ...
             <div className="space-y-2">
              <div className="flex gap-2">
                <Button variant="outline" size="sm" onClick={() => { /* function unchanged */ }} className="flex-1 bg-card-elevated border-border text-text-secondary hover:bg-border"> +0.25L </Button>
                <Button variant="outline" size="sm" onClick={() => { /* function unchanged */ }} className="flex-1 bg-card-elevated border-border text-text-secondary hover:bg-border"> +0.5L </Button>
              </div>
              <div className="flex gap-2">
              ...
              {lastWaterAction > 0 && (
                <Button variant="outline" size="sm" onClick={() => { /* function unchanged */ }} className="w-full bg-card-elevated border-border text-text-secondary hover:bg-red-500/10 hover:text-red-500"> Undo (-{lastWaterAction}L) </Button>
              )}
            </div>
          </div>
        </div>
        
        {/* All other sections unchanged but now use theme-aware classes */}
        {/* ... */}
      </div>
    </div>
  );

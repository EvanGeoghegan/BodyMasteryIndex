  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "bg-[hsl(220,20%,12%)] border-[hsl(220,15%,25%)] text-white",
        position === "popper" &&
...
>(({ className, children, style, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "text-white hover:bg-[hsl(215,100%,45%)] focus:bg-[hsl(215,100%,45%)] data-[highlighted]:bg-[hsl(215,100%,45%)]",
      "hover:text-white focus:text-white data-[highlighted]:text-white",
      className
    )}
    style={{
      color: 'white',
